...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('❄ ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ᴏᴡɴ ᴄʟᴏɴᴇ ʙᴏᴛ ❄️', callback_data='clone')
            ],[
...
# Ask Doubt on telegram @KingVJ01
        ...
        buttons = [[
            ...
            InlineKeyboardButton('☘️ sᴜᴘᴘᴏʀᴛ ☘️', url='synaxchatgroup'),
            InlineKeyboardButton('🥀 ᴜᴘᴅᴀᴛᴇ 🥀', url='https://t.me/synaxnetwork')
            ],[
            InlineKeyboardButton('❄️ ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ᴏᴡɴ ᴄʟᴏɴᴇ ʙᴏᴛ ❄️', callback_data='clone')
            ],[
            InlineKeyboardButton('🌸 ʜᴇʟᴘ 🌸', callback_data='help'),
            InlineKeyboardButton('🦋 ᴀʙᴏᴜᴛ 🦋', callback_data='about')
        ]]
